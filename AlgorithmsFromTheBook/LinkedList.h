...
namespace DoublyLinkedList {
	...
	template <class T>
	struct Node : public SinglyLinkedList::Node<T>{
		Node<T> * prev;

		Node(T _obj) : SinglyLinkedList::Node<T>(_obj), prev(nullptr) {};
		Node(Node<T> * _node) : SinglyLinkedList::Node<T>(_obj), prev(nullptr) {};
	};

	template<class T>
	struct LinkedList : SinglyLinkedList::LinkedList<T>{
	public:
		LinkedList() {  }
